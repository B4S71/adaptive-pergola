"""Manual-override engine for Adaptive Pergola.

``AdaptivePergolaManager`` is the stateful host: it owns per-entity override
...
class AdaptivePergolaManager:
    ...
    def mark_user_command(self, entity_id: str, *, reason: str) -> None:
        ...
        ``adaptive_pergola.set_position`` service before the cover even
