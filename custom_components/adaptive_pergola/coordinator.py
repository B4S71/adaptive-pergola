"""The Coordinator for Adaptive Pergola."""
...
class AdaptiveDataUpdateCoordinator(DataUpdateCoordinator[AdaptivePergolaData]):
    ...
    def __init__(self, hass: HomeAssistant) -> None:
        ...
        self.manager = AdaptivePergolaManager(
            self.hass,
        ...
        # ``AdaptivePergolaData.position_forecast`` each cycle; the sensor
    ...
    async def async_config_entry_first_refresh(self) -> None:
        ...
        # forecast lands on a populated AdaptivePergolaData.  The compute itself
    ...
    def _update_manager_and_covers(self):
        ...
        Registers cover entities with the AdaptivePergolaManager and resets
    ...
    async def async_apply_user_position(
        ...
        *,
        ...
        ``adaptive_pergola.set_position`` service when callers explicitly
        opt in.
        """
    ...
    async def async_apply_user_tilt(
        ...
        *,
        ...
        ``adaptive_pergola.set_tilt`` service, and any future user-facing
...
# AdaptivePergolaManager and inverse_state live in the managers/manual_override
