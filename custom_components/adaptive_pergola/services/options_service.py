...
FIELD_VALIDATORS: dict[str, Any] = {
    ...
    # FIELD_VALIDATORS reconciliation does not reach them.
    CONF_LR_SHADE_EXT_AZIMUTH_1: _num(*_RANGE_LR_SHADE_EXT_AZIMUTH),
    CONF_LR_SHADE_EXT_AZIMUTH_2: _num(*_RANGE_LR_SHADE_EXT_AZIMUTH),
    CONF_LR_SHADE_EXT_DISTANCE_1: _num(*_RANGE_LR_SHADE_EXT_DISTANCE),
    CONF_LR_SHADE_EXT_DISTANCE_2: _num(*_RANGE_LR_SHADE_EXT_DISTANCE),
    CONF_LR_TILT_VERTICAL_PCT: _num(*_RANGE_LR_TILT_VERTICAL_PCT),
    ...
    **{
    ...
    CONF_RESYNC_TRAVEL_THRESHOLD: _range(CONF_RESYNC_TRAVEL_THRESHOLD),
    CONF_RESYNC_MOVEMENT_THRESHOLD: _range(CONF_RESYNC_MOVEMENT_THRESHOLD),
    CONF_RESYNC_COMBINE_MODE: _select_v(
        RESYNC_COMBINE_MODE_AND,
        RESYNC_COMBINE_MODE_OR,
    ),
    CONF_RESYNC_ENDSTOP_MODE: _select_v(
        RESYNC_ENDSTOP_MODE_NEAREST,
        RESYNC_ENDSTOP_MODE_CLOSE,
        RESYNC_ENDSTOP_MODE_OPEN,
    ),
    ...
    **{slot_keys["enabled"]: _bool_v() for slot_keys in CUSTOM_POSITION_SLOTS.values()},
    ...
    CONF_CLOUDY_POSITION: _num(0, 100),
...
_SECTION_GEOMETRY_LOUVERED = frozenset(
    {
        CONF_LR_AXIS_AZIMUTH,
        CONF_LR_PLANE_PITCH,
        CONF_LR_ROOF_HEIGHT,
...
async def _handle_set_force_override(hass: HomeAssistant, call: ServiceCall) -> None:
    ...
    _LOGGER.warning(
        "adaptive_pergola.set_force_override is deprecated (issue #563): "
