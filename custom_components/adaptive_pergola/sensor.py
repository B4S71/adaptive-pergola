...
class AdaptivePergolaCommandSensor(AdaptivePergolaEntity, SensorEntity):
    ...
    def extra_state_attributes(self) -> Mapping[str, Any]:
        ...
        return {
            ...
            "has_shadow_casting_wall": config.get("has_shadow_casting_wall"),
            "shadow_casting_wall_length_m": config.get("shadow_casting_wall_length_m"),
            "shadow_casting_wall_height_m": config.get("shadow_casting_wall_height_m"),
            "shadow_casting_wall_offset_east_m": config.get("shadow_casting_wall_offset_east_m"),
            "shadow_casting_wall_offset_north_m": config.get("shadow_casting_wall_offset_north_m"),
            ...
            "base_shadow_relief_m2": projection.base_shadow_relief_m2,
            "additional_shadow_relief_m2": projection.additional_shadow_relief_m2,
            "total_shadow_relief_m2": projection.total_shadow_relief_m2,
