"""Sensor platform for Adaptive Pergola integration."""
...
from .entity_base import AdaptivePergolaDiagnosticSensorBase, AdaptivePergolaSensorBase
...
class _SensorSpec:
    """Spec for one Adaptive Pergola sensor.
    ...
    diagnostic: bool = (
        True  # False → uses AdaptivePergolaSensorBase (Cover_Position et al.)
    )
...
class _ACPSensor(AdaptivePergolaSensorBase, SensorEntity):
...
class _ACPDiagnosticSensor(AdaptivePergolaDiagnosticSensorBase, SensorEntity):
...
async def async_setup_entry(
    ...
    """Initialize Adaptive Pergola config entry."""
...
def _make_legacy_alias(name: str, suffix: str, base_cls: type) -> type:
    ...
    The class name is the legacy public name (`AdaptivePergolaSunPositionSensor`
...
class AdaptivePergolaTimeSensorEntity(_ACPSensor):
...
AdaptivePergolaSensorEntity = _make_legacy_alias(
    "AdaptivePergolaSensorEntity", "Cover_Position", _ACPSensor
)
AdaptivePergolaSunPositionSensor = _make_legacy_alias(
    "AdaptivePergolaSunPositionSensor", "sun_position", _ACPDiagnosticSensor
)
AdaptivePergolaControlStatusSensor = _make_legacy_alias(
    "AdaptivePergolaControlStatusSensor", "control_status", _ACPDiagnosticSensor
)
AdaptivePergolaDecisionTraceSensor = _make_legacy_alias(
...
AdaptivePergolaManualOverrideEndSensor = _make_legacy_alias(
    "AdaptivePergolaManualOverrideEndSensor",
    "manual_override_end_time",
    _ManualOverrideEndSensor,
)
AdaptivePergolaPositionVerificationSensor = _make_legacy_alias(
    "AdaptivePergolaPositionVerificationSensor",
    "position_verification",
    _ACPDiagnosticSensor,
)
AdaptivePergolaMotionStatusSensor = _make_legacy_alias(
    "AdaptivePergolaMotionStatusSensor", "motion_status", _ACPDiagnosticSensor
)
AdaptivePergolaClimateStatusSensor = _make_legacy_alias(
    "AdaptivePergolaClimateStatusSensor", "climate_status", _ACPDiagnosticSensor
)
