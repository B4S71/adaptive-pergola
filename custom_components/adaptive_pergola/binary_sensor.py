"""Binary Sensor platform for the Adaptive Pergola integration."""
...
async def async_setup_entry(
    ...
    """Set up the Adaptive Pergola binary sensor platform."""
...
class AdaptivePergolaBinarySensor(AdaptivePergolaBaseEntity, BinarySensorEntity):
    """representation of a Adaptive Pergola binary sensor."""
