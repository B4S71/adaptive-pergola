"""Switch platform for the Adaptive Pergola integration."""
...
class _SwitchSpec:
    """Spec for a single AdaptivePergolaSwitch instance.
...
class AdaptivePergolaSwitch(AdaptivePergolaBaseEntity, SwitchEntity, RestoreEntity):
