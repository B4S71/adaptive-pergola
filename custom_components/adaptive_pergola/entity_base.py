"""Base entity classes for Adaptive Pergola integration."""
...
class AdaptivePergolaBaseEntity(CoordinatorEntity["AdaptiveDataUpdateCoordinator"]):
    """Base class for all Adaptive Pergola entities."""
    ...
    def available(self) -> bool:
        ...
        All Adaptive Pergola entities read from coordinator.data in their
...
class AdaptivePergolaSensorBase(AdaptivePergolaBaseEntity):
    """Base class for Adaptive Pergola sensors."""
...
class AdaptivePergolaDiagnosticSensorBase(AdaptivePergolaSensorBase):
