...
from custom_components.adaptive_pergola.managers.time_window import TimeWindowManager
...
def test_after_start_time_entity_returns_true_when_state_is_none():
    ...
    with patch(
        "custom_components.adaptive_pergola.managers.time_window.get_safe_state",
        return_value=None,
    ):
...
def test_is_active_logs_error_when_start_after_end():
    ...
    from custom_components.adaptive_pergola.managers.time_window import (
        TimeWindowManager,
    )
...
def test_gate_valid_template_with_dead_sensor_is_not_indeterminate():
    ...
    with patch(
        "custom_components.adaptive_pergola.managers.time_window."
