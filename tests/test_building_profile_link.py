...
def test_compute_override_keys() -> None:
    ...
    from custom_components.adaptive_pergola.profile_link import compute_override_keys
...
def test_copy_profile_to_cover_skips_overrides() -> None:
    ...
    from custom_components.adaptive_pergola.profile_link import _copy_profile_to_cover
...
def test_clear_cover_override_reinherits_and_removes() -> None:
    ...
    from custom_components.adaptive_pergola.profile_link import clear_cover_override
