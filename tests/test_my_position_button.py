"""Tests for AdaptivePergolaMyPositionButton (button platform, issue #409)."""
...
from custom_components.adaptive_pergola.managers.cover_command import PositionContext
...
async def test_my_position_button_created_when_entities_configured():
    """async_setup_entry must yield exactly one AdaptivePergolaMyPositionButton."""
...
def _make_my_position_button(*, options=None, entities=None):
    """Return a minimal AdaptivePergolaMyPositionButton without HA infrastructure."""
    from custom_components.adaptive_pergola.button import (
        AdaptivePergolaMyPositionButton,
    )
    from custom_components.adaptive_pergola.const import (
    ...
    button = AdaptivePergolaMyPositionButton.__new__(AdaptivePergolaMyPositionButton)
