...
from custom_components.adaptive_pergola.helpers import (
...
def test_state_attr_returns_none_when_entity_missing(mock_hass):
    ...
    from custom_components.adaptive_pergola.helpers import state_attr
...
def test_is_entity_active_none_entity_id(mock_hass):
    ...
    from custom_components.adaptive_pergola.helpers import is_entity_active
