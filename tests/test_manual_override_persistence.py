...
AdaptivePergolaManualOverrideEndSensor inherits RestoreEntity and
rehydrates the coordinator's AdaptivePergolaManager from persisted
...
def _make_sensor(manager):
    """Return an AdaptivePergolaManualOverrideEndSensor wired to *manager*.
    ...
    sensor = object.__new__(AdaptivePergolaManualOverrideEndSensor)
