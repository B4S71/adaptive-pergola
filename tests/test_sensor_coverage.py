...
# ---------------------------------------------------------------------------
# AdaptivePergolaClimateStatusSensor.native_value
# ---------------------------------------------------------------------------
...
def test_climate_status_native_value_summer_mode():
    ...
    sensor = AdaptivePergolaClimateStatusSensor(
...
# ---------------------------------------------------------------------------
# AdaptivePergolaSunPositionSensor.extra_state_attributes — elevation limits
# ---------------------------------------------------------------------------
...
def test_last_action_sensor_native_value_with_timestamp():
    ...
    entry = _make_config_entry()
    sensor = AdaptivePergolaLastActionSensor(
        config_entry_id="test_entry",
        hass=_make_hass(),
        config_entry=entry,
        name="Test",
...
# ---------------------------------------------------------------------------
# AdaptivePergolaControlStatusSensor.extra_state_attributes — cover_type
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# AdaptivePergolaControlStatusSensor — schedule_start / schedule_end attrs
# ---------------------------------------------------------------------------
...
def _make_control_status_sensor(diagnostics: dict):
    ...
    entry = _make_config_entry()
    return AdaptivePergolaControlStatusSensor(
        unique_id="test_entry",
        hass=_make_hass(),
        config_entry=entry,
        name="Test",
