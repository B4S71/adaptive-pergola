...
``AdaptivePergolaManager.handle_state_change`` is unreliable for these covers
because:
...
def test_position_context_tracker_records_and_recognises_id():
    from custom_components.adaptive_pergola.managers.cover_command.position_context import (
        PositionContextTracker,
    )
...
def test_get_open_close_state_uses_state_obj_when_supplied():
    ...
    """
    from custom_components.adaptive_pergola.helpers import get_open_close_state
...
# ===========================================================================
# AdaptivePergolaManager.handle_user_initiated_state_change
# ===========================================================================
