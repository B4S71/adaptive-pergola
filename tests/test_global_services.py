...
from custom_components.adaptive_pergola.services import (
    _resolve_targets,
...
def test_resolve_device_id_maps_to_coordinator():
    ...
    with patch(
        "custom_components.adaptive_pergola.services.dr.async_get",
...
def test_resolve_explicit_target_no_match_logs_warning(caplog):
    ...
    with caplog.at_level(
        logging.WARNING, logger="custom_components.adaptive_pergola.services"
    ):
        result = _resolve_targets(hass, call)
...
def test_resolve_diagnostic_sensor_maps_to_owning_coordinator():
    ...
    with patch(
        "custom_components.adaptive_pergola.services.er.async_get",
