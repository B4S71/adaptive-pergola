...
# ===========================================================================
# Fix 2: Tolerance floor in AdaptivePergolaManager.handle_state_change
# ===========================================================================


def _make_manager():
    """Build a real AdaptivePergolaManager for testing handle_state_change."""
...
def test_position_exactly_at_tolerance_boundary_not_flagged():
    ...
    """
    from custom_components.adaptive_pergola.const import POSITION_TOLERANCE_PERCENT
