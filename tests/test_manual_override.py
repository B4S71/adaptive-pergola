...
def test_is_in_grace_period_returns_false_when_no_timestamp():
    ...
    from custom_components.adaptive_pergola.const import COMMAND_GRACE_PERIOD_SECONDS
...
async def test_reset_button_clears_manual_override_and_sends_post_refresh_position():
    ...
    """
    from custom_components.adaptive_pergola.button import AdaptivePergolaButton
    ...
    button = AdaptivePergolaButton.__new__(AdaptivePergolaButton)
