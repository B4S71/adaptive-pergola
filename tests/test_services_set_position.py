...
def _make_coord(
    *,
    ...
    from custom_components.adaptive_pergola.coordinator import (  # noqa: PLC0415
...
def test_resolve_targets_wrapper_delegates_to_services_module() -> None:
    ...
    from custom_components.adaptive_pergola.services.set_position_service import (
    ...
    with patch(
        "custom_components.adaptive_pergola.services._resolve_targets",
...
async def test_no_floor_active_position_passes_through() -> None:
    ...
    with patch(
        "custom_components.adaptive_pergola.services.set_position_service._resolve_targets",
...
async def test_clamp_emits_info_log(caplog) -> None:
    ...
    with (
        ...
        caplog.at_level(logging.INFO, logger="custom_components.adaptive_pergola"),
    ):
        await async_handle_set_position(call)
