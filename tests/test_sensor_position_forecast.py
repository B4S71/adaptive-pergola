...
def _make_sensor_with_coord(forecast):
    ...
    from custom_components.adaptive_pergola.coordinator import AdaptivePergolaData

    sensor = MagicMock()
    sensor.coordinator = MagicMock()
    sensor.coordinator.data = AdaptivePergolaData(
...
def test_value_and_attrs_do_not_recompute_forecast(monkeypatch):
    ...
    monkeypatch.setattr(
        "custom_components.adaptive_pergola.forecast.build_forecast_for_coord",
        build_mock,
    )

    from custom_components.adaptive_pergola.forecast import (
        Forecast,
        ForecastEvent,
        ForecastSample,
    )
    ...
    # is deterministic.
    from custom_components.adaptive_pergola import sensor as sensor_mod
...
def test_value_returns_none_when_forecast_missing():
    ...
    from custom_components.adaptive_pergola.sensor import _position_forecast_value
...
def test_attrs_returns_none_when_forecast_missing():
    ...
    from custom_components.adaptive_pergola.sensor import _position_forecast_attrs
...
def test_no_recompute_across_n_state_writes(monkeypatch):
    ...
    from custom_components.adaptive_pergola.forecast import Forecast
    from custom_components.adaptive_pergola.sensor import (
        _position_forecast_attrs,
        _position_forecast_value,
    )
