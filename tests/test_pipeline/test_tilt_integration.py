...
class TestNonVenetianPolicyTiltPassthrough:
    ...
    @pytest.mark.parametrize(
        ...
        [
            pytest.param(
                "tests.compat_policies.CompatBlindPolicy",
                id="blind",
            ),
            pytest.param(
                "tests.compat_policies.CompatAwningPolicy",
                id="awning",
            ),
            pytest.param(
                "tests.compat_policies.CompatTiltPolicy",
                id="tilt",
            ),
        ],
    )
    ...
    def test_blind_none_result_returns_none(self):
        ...
        from tests.compat_policies import CompatBlindPolicy as BlindPolicy
