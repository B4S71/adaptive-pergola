...
from custom_components.adaptive_pergola.pipeline.handlers.manual_override import (
    ManualOverrideHandler,
)
from custom_components.adaptive_pergola.pipeline.handlers.motion_timeout import (
...
from custom_components.adaptive_pergola.pipeline.handlers.glare_zone import (
    GlareZoneHandler,
)
from custom_components.adaptive_pergola.pipeline.handlers.solar import SolarHandler
...
class TestClimateDataPropagation:
    ...
    def test_registry_copies_tilt_from_winning_handler(self) -> None:
        ...
        from custom_components.adaptive_pergola.pipeline.handlers.solar import (
            SolarHandler,
        )
        from custom_components.adaptive_pergola.pipeline.types import PipelineResult
        from custom_components.adaptive_pergola.const import ControlMethod as CM
...
class TestCustomPositionConfigurablePriority:
    ...
    def test_high_priority_custom_beats_weather_override(self) -> None:
        ...
        from custom_components.adaptive_pergola.pipeline.handlers.weather import (
...
class TestGlareZoneVsClimatePriority:
    ...
    def test_glare_zone_beats_climate_glare_control(self) -> None:
        ...
        with patch(
            "custom_components.adaptive_pergola.pipeline.handlers.glare_zone.glare_zone_effective_distance",
            return_value=1.0,
        ):
