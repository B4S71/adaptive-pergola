...
from custom_components.adaptive_pergola.position_utils import PositionConverter
...
def test_issue_24_sunset_position_with_conditional_min_pos(mock_sun_data, mock_logger):
    ...
    from custom_components.adaptive_pergola.pipeline.types import PipelineSnapshot

    with patch(
        "custom_components.adaptive_pergola.engine.sun_geometry.datetime"
    ) as mock_datetime:
