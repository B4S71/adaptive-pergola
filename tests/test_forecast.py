...
import custom_components.adaptive_pergola.sun as _sun_mod
...
class TestForecastMatchesLivePipeline:
    ...
    def test_solar_sample_equals_compute_solar_position(self):
        from custom_components.adaptive_pergola.pipeline.helpers import (
...
async def test_async_recompute_forecast_runs_in_executor(monkeypatch):
    ...
    """
    from custom_components.adaptive_pergola import coordinator as coord_mod
...
class TestForecastShimEndOfWindow:
    ...
    def _run(self, coord):
        from custom_components.adaptive_pergola import forecast as fc_mod
...
async def test_async_recompute_forecast_handles_missing_data(monkeypatch):
    ...
    promotes the value into `AdaptivePergolaData`.
    """
    from custom_components.adaptive_pergola import coordinator as coord_mod
...
class TestNearestIndex:
    ...
    def test_exact_grid_points_match_linear_scan(self):
        ...
        from custom_components.adaptive_pergola.forecast import _nearest_index
