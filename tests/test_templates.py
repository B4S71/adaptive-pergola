...
from custom_components.adaptive_pergola.config_types import RuntimeConfig, _num_or
...
from custom_components.adaptive_pergola.state.climate_provider import ClimateProvider
from custom_components.adaptive_pergola.templates import (
    TemplateResolver,
    combine_with_mode,
    is_template_string,
    render_condition,
