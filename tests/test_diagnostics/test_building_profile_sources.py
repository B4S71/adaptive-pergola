...
from custom_components.adaptive_pergola.diagnostics.builder import DiagnosticsBuilder
...
def test_linked_override_source(builder: DiagnosticsBuilder):
    ...
    from custom_components.adaptive_pergola.const import CONF_PROFILE_SENSOR_OVERRIDES
