...
class TestTiltTrace:
    ...
    def test_nan_result_branch(self, tilt_cover_instance, monkeypatch):
        ...
        import custom_components.adaptive_pergola.engine.covers.tilt as tilt_mod
...
class TestSolarCalculationSensorSpec:
    ...
    def _spec(self):
        from custom_components.adaptive_pergola.sensor import _DIAGNOSTIC_SPECS
    ...
    def test_resolved_class_has_match_all(self):
        ...
        from custom_components.adaptive_pergola.sensor import _DIAGNOSTIC_CLASSES
