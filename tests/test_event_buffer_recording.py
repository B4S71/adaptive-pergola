...
def _make_transit_coordinator(
    ...
    *,
    ...
    from custom_components.adaptive_pergola.managers.cover_command.state_classifier import (
        StateClassifier,
    )
...
class TestSunsetWindowOpenedEvent:
    ...
    def _make_coord(self, *, sunset_pos: int = 25) -> MagicMock:
        ...
        from custom_components.adaptive_pergola.const import CONF_SUNSET_POS
        from custom_components.adaptive_pergola.managers.cover_command import (
            PositionContext,
        )
        from custom_components.adaptive_pergola.state.window_transition_tracker import (
...
class TestReconcileGaveUpEvent:
    ...
    async def test_reconcile_gave_up_records_event_after_max_retries(self) -> None:
        ...
        with patch(
            "custom_components.adaptive_pergola.managers.cover_command.check_cover_features",
            return_value={
