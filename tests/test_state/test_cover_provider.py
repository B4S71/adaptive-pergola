...
from custom_components.adaptive_pergola.state.cover_provider import (
    CoverProvider,
...
_BASE_MODULE = "custom_components.adaptive_pergola.cover_types.base"
...
class TestReadSingleCapabilities:
    ...
    def test_returns_default_when_entity_not_ready(self, provider, mock_hass):
        ...
        with patch(
            "custom_components.adaptive_pergola.state.cover_provider.check_cover_features",
            return_value=None,
        ):
