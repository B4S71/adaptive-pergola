...
from custom_components.adaptive_pergola.managers.cover_command.gates import (
...
def test_read_position_with_capabilities_position_cover(cmd_svc, mock_hass):
    ...
    with patch(
        "custom_components.adaptive_pergola.cover_types.base.state_attr",
        return_value=42,
    ):
...
def test_check_time_delta_exceeds_threshold(cmd_svc):
    ...
    with patch(
        "custom_components.adaptive_pergola.managers.cover_command.get_last_updated",
