...
async def test_open_close_tilt_stop_dropped_when_source_unavailable(
    ...
    caplog.set_level(logging.DEBUG, logger="custom_components.adaptive_pergola.cover")
...
def test_source_friendly_label_state_friendly_name(hass) -> None:
    ...
    from custom_components.adaptive_pergola.cover import _source_friendly_label
