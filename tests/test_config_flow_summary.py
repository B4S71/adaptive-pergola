...
def test_dry_run_banner_shown_when_enabled():
    ...
    from custom_components.adaptive_pergola.const import CONF_DRY_RUN
...
def test_blank_start_end_time_not_shown_as_literal():
    ...
    """
    from custom_components.adaptive_pergola.const import BLANK_TIME
...
def test_return_sunset_line_rendered():
    ...
    from custom_components.adaptive_pergola.const import CONF_RETURN_SUNSET
...
def test_end_of_window_footgun_when_return_off():
    ...
    from custom_components.adaptive_pergola.const import CONF_END_OF_WINDOW_POS
...
def test_weather_state_list_in_cloud_line():
    ...
    from custom_components.adaptive_pergola.const import CONF_WEATHER_STATE
...
def test_transparent_blind_note_on_climate_line():
    ...
    from custom_components.adaptive_pergola.const import CONF_TRANSPARENT_BLIND
...
def test_open_close_threshold_in_position_limits():
    ...
    from custom_components.adaptive_pergola.const import CONF_OPEN_CLOSE_THRESHOLD
...
async def test_compute_todays_sun_times_returns_expected_shape():
    ...
    with (
        patch(
            "custom_components.adaptive_pergola.state.sun_provider."
            "SunProvider.create_sun_data",
            return_value=sun_data_stub,
        ),
        patch(
            "custom_components.adaptive_pergola.engine.sun_geometry.SunGeometry",
...
def test_motion_summary_hold_mode_says_hold_position():
    ...
    from custom_components.adaptive_pergola.const import CONF_MOTION_TIMEOUT_MODE
...
def test_config_summary_shows_proxy_cover_disabled_by_default():
    ...
    from custom_components.adaptive_pergola.const import CONF_ENABLE_PROXY_COVER
...
def test_summary_shows_default_tilt_when_set():
    ...
    from custom_components.adaptive_pergola.const import CONF_DEFAULT_TILT
...
def test_summary_shows_sunset_tilt_when_set():
    ...
    from custom_components.adaptive_pergola.const import CONF_SUNSET_TILT
...
def test_summary_shows_custom_slot_tilt_when_set():
    ...
    from custom_components.adaptive_pergola.const import CUSTOM_POSITION_SLOTS
...
def test_position_schema_accepts_sunset_time_entity():
    ...
    from custom_components.adaptive_pergola.config_flow import BEHAVIOR_SCHEMA
