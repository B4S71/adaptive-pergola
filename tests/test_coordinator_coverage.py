...
from custom_components.adaptive_pergola.managers.toggles import ToggleManager
...
def _make_coordinator():
    ...
    from custom_components.adaptive_pergola.diagnostics.event_buffer import (
        EventBuffer,
    )
...
def _attach_window_tracker(coord, *, prev_state: bool | None) -> None:
    ...
    from custom_components.adaptive_pergola.state.window_transition_tracker import (
...
async def test_start_motion_timeout_callback_triggers_refresh():
    ...
    from custom_components.adaptive_pergola.managers.motion import MotionManager
...
async def test_start_weather_timeout_callback_triggers_refresh():
    ...
    from custom_components.adaptive_pergola.managers.weather import WeatherManager
...
async def test_window_close_sends_reposition_when_auto_control_on():
    ...
    from custom_components.adaptive_pergola.const import CONF_DEFAULT_HEIGHT
    ...
    with patch(
        "custom_components.adaptive_pergola.coordinator.compute_effective_default",
...
def test_read_time_entity_returns_none_for_none_entity_id():
    ...
    from custom_components.adaptive_pergola.coordinator import _read_time_entity
...
def test_read_time_entity_parses_iso_datetime():
    ...
    with patch(
        "custom_components.adaptive_pergola.coordinator.dt_util.now",
...
def test_read_time_entity_dst_spring_forward_boundary():
    ...
    from custom_components.adaptive_pergola.coordinator import _read_time_entity
    from custom_components.adaptive_pergola.helpers import _local_naive_to_utc_naive
...
def test_compute_current_effective_default_passes_sunset_entity_time():
    ...
    with (
        patch(
            "custom_components.adaptive_pergola.coordinator._read_time_entity",
