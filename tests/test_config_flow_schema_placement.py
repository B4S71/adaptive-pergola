...
from custom_components.adaptive_pergola.config_dynamic import sun_tracking_schema
...
def test_default_tilt_absent_in_blind_schema() -> None:
    ...
    from custom_components.adaptive_pergola.const import CONF_DEFAULT_TILT, CoverType
...
def test_sunset_tilt_absent_in_blind_schema() -> None:
    ...
    from custom_components.adaptive_pergola.const import CONF_SUNSET_TILT, CoverType
...
def test_daytime_gate_template_is_optional_round_trips_absent() -> None:
    ...
    from custom_components.adaptive_pergola.const import CONF_DAYTIME_GATE_TEMPLATE
...
def test_daytime_gate_sensors_default_empty_list() -> None:
    ...
    from custom_components.adaptive_pergola.const import CONF_DAYTIME_GATE_SENSORS
...
def test_weather_enabled_is_first_key_with_default_false() -> None:
    ...
    from custom_components.adaptive_pergola.const import CONF_WEATHER_ENABLED
