...
class TestClimateCoverData:
    ...
    @pytest.mark.unit
    def test_outside_temperature_field(self):
        """Test outside temperature is a simple field."""
        climate_data = _make_climate(outside_temperature="22.5")
        assert climate_data.outside_temperature == "22.5"

    @pytest.mark.unit
    def test_inside_temperature_field(self):
        """Test inside temperature is a simple field."""
        climate_data = _make_climate(inside_temperature="23.0")
        assert climate_data.inside_temperature == "23.0"

    @pytest.mark.unit
    def test_get_current_temperature_outside(self):
    ...
    @pytest.mark.unit
    def test_get_current_temperature_inside(self):
    ...
    @pytest.mark.unit
    def test_outside_high_true(self):
    ...
    @pytest.mark.unit
    def test_outside_high_with_none_value(self):
