...
def test_determine_control_status_motion_timeout():
    ...
    from custom_components.adaptive_pergola.const import ControlStatus
...
# --- AdaptivePergolaMotionStatusSensor tests ---
...
def test_motion_status_sensor_no_timestamp_device_class():
    ...
    assert (
        getattr(AdaptivePergolaMotionStatusSensor, "_attr_device_class", None)
...
def test_motion_control_switch_enabled_for_media_player_only():
    ...
    from custom_components.adaptive_pergola.switch import _has_motion_sensors
...
def test_configured_handlers_includes_motion_for_media_player_only():
    ...
    from custom_components.adaptive_pergola.sensor import _configured_handlers
